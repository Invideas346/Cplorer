...
int main(int argc, char** argv)
{
    ...
    ui::component parent_tree([&content_parent_dir, &current_dir, &win, &cursor]() -> void {
    ...
    ui::component current_tree([&content_current_dir, &selected_entry, &current_dir, &win,
                                &cursor]() -> void {
        uint32_t win_width = 0, win_height = 0;
    ...
    ui::component preview_tab([&content_child_dir, &file_preview, &directory_selected,
                               &selected_entry, &win, &cursor]() -> void {
        uint32_t win_width = 0, win_height = 0;
        uint32_t line_cnt = 0;
